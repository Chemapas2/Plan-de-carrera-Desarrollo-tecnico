...
# Seis posibilidades visibles: BÁSICO, CONTROLA, SUPERA, CERTIFICADO, EXCELENTE y MÁSTER.
PROFILE_THRESHOLDS = {
    "Básico": 1.0,
    "Controla": 2.0,
    "Supera": 3.0,
...
with assessment_tab:
    ...
    with sidebar.expander("Configurar umbrales de perfil", expanded=False):
        PROFILE_THRESHOLDS["Básico"] = st.slider("Límite superior Básico", 0.1, 2.0, 1.0, 0.1)
        PROFILE_THRESHOLDS["Controla"] = st.slider("Límite superior Controla", PROFILE_THRESHOLDS["Básico"] + 0.1, 3.0, 2.0, 0.1)
        PROFILE_THRESHOLDS["Supera"] = st.slider("Límite superior Supera", PROFILE_THRESHOLDS["Controla"] + 0.1, 4.0, 3.0, 0.1)
